...
namespace BackendService.DAL.Migrations
{
    ...
    [Migration("20260430153148_UpdatePostPendingEntity")]
    partial class UpdatePostPendingEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendService.DAL.Models.PostPendingEntity", b =>
                {
                    ...
                    b.PrimitiveCollection<HashSet<int>>("ImageIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.PrimitiveCollection<HashSet<int>>("TagIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
